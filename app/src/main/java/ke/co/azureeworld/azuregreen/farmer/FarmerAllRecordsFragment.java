 ...
 * Use the {@link FarmerAllRecordsFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FarmerAllRecordsFragment extends Fragment {
    RecyclerView recyclerView;
    FarmerAllRecordsAdapter adapter;
    List<FarmerRecord> records;
    FirebaseDatabase firebaseDatabase = FirebaseDatabase.getInstance();
    DatabaseReference mRef = firebaseDatabase.getReference().child("farmer_records");
    ...
    public FarmerAllRecordsFragment() {
     ...
     * @return A new instance of fragment FarmerAllRecordsFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static FarmerAllRecordsFragment newInstance(String param1, String param2) {
        FarmerAllRecordsFragment fragment = new FarmerAllRecordsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_farmer_all_records, container, false);
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        recyclerView = view.findViewById(R.id.recycler_view_all_records_farmer);
