...
public class BuyerOrderViewModel extends ViewModel {
    ...
    public void setData(String cropName, String cropDescription, String kgs, String orderDate, String orderTime, String price, String status, String location, String email ){
